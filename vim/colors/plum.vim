...
"   - 4: Highlight only the background of the current line number.
"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    \ {
        \ 'group': "FoldColumn",
        \ 'dark': {'fg': s:dark.lighterbg2, 'bg': s:dark.bg},
        \ 'light': {'fg': s:light.grey3, 'bg': s:light.bg},
        \ 'style': ""
    \ })
    ...
    let s:cursor_line_nr_only_bg =
    \ {
        \ 'group': "CursorLineNr",
        \ 'dark': {'fg': s:dark.lighterbg2, 'bg': s:dark.lighterbg1},
        \ 'light': {'fg': s:light.grey3, 'bg': s:light.grey4},
        \ 'style': "none"
    \ }
    ...
    elseif g:plum_cursorline_style == 3
        call <SID>H(s:cursor_line_hidden)
        call <SID>H(s:cursor_line_nr)
    elseif g:plum_cursorline_style == 4
        call <SID>H(s:cursor_line_hidden)
        call <SID>H(s:cursor_line_nr_only_bg)
    endif
    ...
    \ {
        \ 'group': "Hidden",
        \ 'dark': {'fg': s:dark.bg, 'bg': s:dark.bg},
        \ 'light': {'fg': s:light.bg, 'bg': s:light.bg},
        \ 'style': "none"
    \ })
