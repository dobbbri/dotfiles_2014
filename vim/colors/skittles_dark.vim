...
hi String guifg=#A6E22E ctermfg=113
...
hi Define guifg=#5FAAC7 ctermfg=1
...
hi DiffDelete guifg=red ctermfg=89 guibg=#1E0010 ctermbg=233
hi DiffText guibg=#4C4745 ctermbg=238

hi Directory guifg=#A6E22E ctermfg=148
hi Error guifg=red ctermfg=89 guibg=#1E0010 ctermbg=233
...
hi Function guifg=#8ac6f2 ctermfg=25
...
hi PreProc guifg=#5FAAC7 ctermfg=148
hi Question guifg=#8ac6f2 ctermfg=81
hi Repeat guifg=#C4BE89 ctermfg=1
...
hi Special guifg=#70F0F0 ctermfg=81 guibg=bg
...
hi Structure guifg=#8ac6f2 ctermfg=81 cterm=bold gui=bold
hi Tag guifg=#8ac6f2 ctermfg=117
hi Title guifg=#C4BE89 ctermfg=203
...
hi VertSplit guifg=bg ctermfg=244 guibg=#778899<F2> ctermbg=0
...
hi Normal guifg=#F8F8F2 ctermfg=248 guibg=#000000 ctermbg=234
...
hi LineNr guifg=#FFFFFF ctermfg=15 guibg=#000000 ctermbg=0
hi NonText guifg=bg ctermfg=250 guibg=bg ctermbg=235
